<script lang="ts">
    let today = new Date();
    let endDate = new Date("2025-09-31T00:00:00+09:00"); // Replace with your end date
    let remainText = "";
    let militaryTime = "";
    ...
    function militaryTimer() {
        let entranceDate = new Date("2024-04-01T00:00:00+09:00"); // Replace with your entrance date
