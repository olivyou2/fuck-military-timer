<script lang="ts">
    let today = new Date();
    let endDate = new Date("2026-07-01T00:00:00+09:00"); // Replace with your end date
    let remainText = "";
    let militaryTime = "";
    ...
    function militaryTimer() {
        let entranceDate = new Date("2024-03-02T00:00:00+09:00"); // Replace with your entrance date
