<script lang="ts">
    let today = new Date();
    let endDate = new Date("2025-08-18T00:00:00+09:00"); // Replace with your end date
    let remainText = "";
    let militaryTime = "";
    ...
    function militaryTimer() {
        let entranceDate = new Date("2024-02-19T00:00:00+09:00"); // Replace with your entrance date
